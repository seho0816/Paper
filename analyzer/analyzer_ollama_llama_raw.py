...
print("=== 순수 LLM 보안 분석 (Llama 3.2 / No RAG) ===")
...
while True:
    ...
    filename = os.path.join("result", f"result_ollama_llama3.2_raw_{base_name}_{now}.txt")
    
    with open(filename, "w", encoding="utf-8") as f:
        f.write(f"=== 순수 LLM(Llama 3.2) 보안 분석 리포트 ({now}) ===\n")
