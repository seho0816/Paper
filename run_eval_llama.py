"""run_eval_llama.py (v3) — Llama 3.2 + Tree-sitter + RAG + MITRE"""
import time, ollama
from config import MODEL_LLAMA_RAG, OLLAMA_LLAMA
...
def main():
    ...
    run_eval_loop(MODEL_LLAMA_RAG, evaluate, memory_label="MB")
